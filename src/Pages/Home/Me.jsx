...
const Me = () => {
    ...
    return (
        <>
        <div className=''>
        <div className="bg-[url('https://images.unsplash.com/photo-1607705703571-c5a8695f18f6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2dyYW1tZXIlMjBnaXJsfGVufDB8fDB8fHww&auto=format&fit=crop&w=1200&h=600')] w-[1100px] h-[600px]">
           <div className='grid justify-items-center w-96 mx-auto'>
           <p className='text-8xl font-bold text-white mt-20'>Shanta Mahfuza</p>
